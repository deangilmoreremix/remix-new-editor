// tests/e2e/blank-studios-debug2.spec.js
//
// Debug remaining blank studios after backend fix.
...
const BLANK_STUDIOS = [
  'academy', 'audio', 'avatar', 'chat', 'cinema', 'cinema-template',
  'commercial', 'commits', 'explore', 'render', 'timeline', 'upscale',
  'videotools', 'viral',
];
...
test.describe('Blank studio debug 2', () => {
  test('reports state for still-blank studios', async ({ page }) => {

...
import CombinedSettings from '../../../components/settings/combined-settings/CombinedSettings';

import BasicTextMask from '../../../components/settings/text-mask/tabs/Basic';
import AdvancedTextMask from '../../../components/settings/text-mask/tabs/Advanced';
...
import { INITIAL_VALUES as lottieJsonSettings } from './lottie-json';
import { INITIAL_VALUES as textMaskSettings } from './text-mask';

export const CUSTOM_ELEMENT_TABS = {
  [POPCORN_ELEMENT_TYPES.TEXT_MASK]: {
    [BASIC]: BasicTextMask,
    [ADVANCED]: AdvancedTextMask,
  },
};
...
export const SETTINGS_COMPONENTS = {
  ...
  [POPCORN_ELEMENT_TYPES.LOTTIE_JSON]: DefaultSettings,
  [POPCORN_ELEMENT_TYPES.GOOGLE_MAP]: GoogleMapSettings,
  [POPCORN_ELEMENT_TYPES.BACKGROUND]: DefaultSettings,
  [POPCORN_ELEMENT_TYPES.TEXT_MASK]: DefaultSettings,
  [POPCORN_ELEMENT_TYPES.COMBINED]: CombinedSettings,
};
...
export const DEFAULT_SETTINGS = {
  ...
  [POPCORN_ELEMENT_TYPES.LOTTIE_JSON]: lottieJsonSettings,
  [POPCORN_ELEMENT_TYPES.GOOGLE_MAP]: googleMapSettings,
  [POPCORN_ELEMENT_TYPES.BACKGROUND]: backgroundSettings,
  [POPCORN_ELEMENT_TYPES.TEXT_MASK]: textMaskSettings,
};

export const SECTIONS = {
  basic: 'BASIC',
  leadGeneration: 'LEAD_GEN',
  advanced: 'ADVANCED',
  creative: 'CREATIVE',
  videControl: 'VIDEO_CONTROL',
};
...
export const CUSTOM_TABS = {
  ...
  [POPCORN_ELEMENT_TYPES.LOTTIE_JSON]: [{ label: BASIC }],

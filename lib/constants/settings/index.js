...
import CommonSettings from '../../../components/settings/common/Common';
...
import {
  ...
  CLIP_EDITOR_TAB,
  JSON_BUTTON_TAB,
  INTEGRATIONS, POPCORN_ELEMENT_LABELS,
} from '../popcorn';
...
export const SETTINGS_COMPONENTS = {
  [POPCORN_ELEMENT_TYPES.PAUSE]: CommonSettings,
  ...
  [POPCORN_ELEMENT_TYPES.LOOP]: CommonSettings,
...
export const CUSTOM_TABS = {
  ...
  [POPCORN_ELEMENT_TYPES.PAUSE]: [{ label: POPCORN_ELEMENT_LABELS[POPCORN_ELEMENT_TYPES.PAUSE] }],
  [POPCORN_ELEMENT_TYPES.LOOP]: [{ label: POPCORN_ELEMENT_LABELS[POPCORN_ELEMENT_TYPES.LOOP] }],

import ValidationTimeInput from '../../components/form/ValidationTimeInput';
...
import FormEnterBlurField from '../../components/form/FormEnterBlurField';
import MultipleFormSelect from '../../components/form/MultipleFormSelect';

export const TIME = 'time';
export const DEFAULT_TIME = 'defaultTime';
...
export const BLUR_ENTER_INPUT = 'blurInputField';
export const MULTIPLE_SELECT = 'multipleSelect';

export const INPUT_ELEMENTS = {
  [TIME]: ValidationTimeInput,
  [DEFAULT_TIME]: TimeInput,
  ...
  [BLUR_ENTER_INPUT]: FormEnterBlurField,
  [MULTIPLE_SELECT]: MultipleFormSelect,
};

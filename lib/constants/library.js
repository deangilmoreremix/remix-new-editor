...
export const libraryProviders = {
  ...
  [LIBRARY_KEYS.UNSPLASH]: {
    name: 'Unsplash',
    icon: unsplashIcon,
    apiUrl: config.mediaProviders.UNSPLASH.apiUrl,
    imagesApiPath: config.mediaProviders.UNSPLASH.imagesApiPath,
    apiKey: config.mediaProviders.UNSPLASH.apiKey,
  },
  [LIBRARY_KEYS.PEXELS]: {
    name: 'Pexels',
    icon: pexelsIcon,
  ...
  [LIBRARY_KEYS.DROPMOCK]: {
    ...
    // TODO: update
    icon: pexelsIcon,
    apiUrl: config.mediaProviders.DROPMOCK.apiUrl,
    videosApiPath: config.mediaProviders.DROPMOCK.videosApiPath,
    imagesApiPath: config.mediaProviders.DROPMOCK.imagesApiPath,
    apiKey: config.mediaProviders.DROPMOCK.apiKey,
  },
};
...
export const tabItems = {
  ...
  // todo uncoment after implementing
  // [LIBRARY_TABS.AUDIO]: {
  //   search,
  //   label: 'Audios',
...
export const DEFAULT_PROVIDERS = {
  [LIBRARY_KEYS.USER]: libraryProviders.USER,
};

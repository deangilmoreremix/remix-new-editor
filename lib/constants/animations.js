import { POPCORN_ELEMENT_TYPES as POPCORN_ELEMENTS } from './popcorn';
...
export const ANIMATION_GROUPS = {
  [POPCORN_ELEMENTS.LEAD_GENERATOR]: [ANIMATION_TYPES.IN, ANIMATION_TYPES.OUT],
  [POPCORN_ELEMENTS.RETARGET]: [ANIMATION_TYPES.IN, ANIMATION_TYPES.OUT],
};
...
export const OVERFLOW_NONE_CLASS = 'overflow-none';

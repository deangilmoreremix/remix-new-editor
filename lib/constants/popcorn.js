...
export const POPCORN_ELEMENT_LABELS = {
  ...
  [POPCORN_ELEMENT_TYPES.JSON_BUTTON]: 'Button',
  [MEDIA_TYPES.LOTTIE_JSON]: 'Sticker',
  [POPCORN_ELEMENT_TYPES.LOOP]: 'Loop',
};

export const NO_SETTINGS_ELEMENT_TYPES = [
  POPCORN_ELEMENT_TYPES.LOTTIE_JSON,
];
...
export const JSON_BUTTON_TAB = 'JSON BUTTON';
export const PAUSE_TAB = 'PAUSE';
export const LOOP_TAB = 'LOOP';

// labels and others
export const LABEL_CLICK_TO_PHONE = 'Link URL or phone number';

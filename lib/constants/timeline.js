...
import OverlayElement from '../../components/common/timeline/elements/OverlayElement';
...
export const TIMELINE_COMPONENTS = {
  ...
  [POPCORN_ELEMENT_TYPES.JSON_TRANSITION]: DefaultElement,
  ...
  [POPCORN_ELEMENT_TYPES.JSON_TRANSITION]: OverlayElement,
};

...
const BrightbeanScheduleModal = dynamic(() => import('../../components/modals/BrightbeanScheduleModal'));
const BrightbeanAnalyticsDrawer = dynamic(() => import('../../components/modals/BrightbeanAnalyticsDrawer'));
const AICaptionAssistantModal = dynamic(() => import('../../components/modals/AICaptionAssistant'));
...
export const BRIGHTBEAN_SCHEDULE_MODAL = 'brightbean-schedule';
export const BRIGHTBEAN_ANALYTICS_MODAL = 'brightbean-analytics';
export const AI_CAPTION_ASSISTANT_MODAL = 'ai-caption-assistant';
...
export const MODAL_CONFIG = [
  ...
  {
    id: BRIGHTBEAN_SCHEDULE_MODAL,
    className: `${BRIGHTBEAN_SCHEDULE_MODAL}-modal`,
    renderer: BrightbeanScheduleModal,
    maxWidth: 'md',
  },
  {
    id: BRIGHTBEAN_ANALYTICS_MODAL,
    className: `${BRIGHTBEAN_ANALYTICS_MODAL}-modal`,
    renderer: BrightbeanAnalyticsDrawer,
    maxWidth: 'lg',
  },
  {
    id: AI_CAPTION_ASSISTANT_MODAL,
    className: `${AI_CAPTION_ASSISTANT_MODAL}-modal`,
    renderer: AICaptionAssistantModal,
    maxWidth: 'sm',
  },
];

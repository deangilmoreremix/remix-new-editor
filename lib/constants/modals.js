...
const SocialPublishModal = lazy(() => import('../../components/modals/SocialPublishModal'));

const RecorderModal = lazy(() => import('../../components/modals/RecorderModal'));
const PixoImageEditorModal = lazy(() => import('../../components/modals/PixoImageEditorModal'));
const ImglyImageEditorModal = lazy(() => import('../../components/modals/ImglyImageEditorModal'));
const ImglyImageEditorModalCropper = lazy(() => import('../../components/modals/ImglyImageEditorModalCropper'));

const AdvanceImageEditorModal = lazy(() => import('../../components/modals/AdvanceImageEditorModal'));
// const PinturaImageEditorModal = lazy(() => import('../../components/modals/PinturaImageEditorModal'));
const PassportMarkerModal = lazy(() => import('../../components/common/AdvanceImageEditor/PassportMakerModal'));

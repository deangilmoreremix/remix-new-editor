...
export const DEFAULT_IFRAME_STYLE = `<!--- embed styling ---->
<style> 
...
export const EMBED_LOCATIONS = [
  ...
  },
  {
    ...
    embedGenerator: (url, width, height) => `${DEFAULT_IFRAME_STYLE} <div class="iframe-container"><iframe id='vr-${url.split('/').reverse()[0]}' src='${url}' width='${width}' height='${height}' frameborder='0' allow="autoplay; fullscreen" mozallowfullscreen webkitallowfullscreen allowfullscreen></iframe></div>`,
  },
  {
    key: 'wordpress',
    label: 'WordPress',
...
export const FACEBOOK_EMBED_LOCATIONS = [
  ...EMBED_LOCATIONS.slice(0, EMBED_LOCATIONS.length - 1),
  {
    key: 'facebook-page',
    label: 'Facebook Page',
  }, EMBED_LOCATIONS[EMBED_LOCATIONS.length - 1],
];

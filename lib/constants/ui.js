...
export const ACTION_TO_TRASH = 'to_trash';
...
export const PROJECT_ADMIN_MENU = [
  { title: 'Save as', icon: saveAsIcon, action: SAVE_PROJECT_MODAL },
];

export const SIDEBAR_MENU_ITEMS = (modified, common) => [
  { title: 'Save', icon: saveAsIcon, action: ACTION_SAVE_PROJECT },
  { title: 'New a project...', icon: newProjectIcon, action: ACTION_NEW_PROJECT },
  { title: 'Make a copy', icon: makeCopyIcon, action: ACTION_MAKE_COPY },
  { title: 'Rename project', icon: renameProjectIcon, action: ACTION_RENAME_PROJECT },
  { title: 'Watch video', icon: watchVideoIcon, action: ACTION_WATCH_VIDEO },
  {
    title: 'Move to trash',
    icon: trashIcon,
    action: ACTION_TO_TRASH,
    disabled: modified,
    url: `${common.prefixes.projects}.${common.whiteLabelManager.domain || common.whiteLabel.devDefault}`,
  },
];

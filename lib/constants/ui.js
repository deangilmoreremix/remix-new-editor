...
import dashboardIcon from '../../public/static/svgImages/header/dashboard_icon.svg';
import smartaimentorsIcon from '../../public/static/svgImages/header/smartaimentors.svg';
...
import shortcutIcon from '../../public/static/svgImages/header/Shortcut.svg';
...
import zapierIcon from '../../public/static/svgImages/menu/zapier-icon-svgrepo-com.svg';
...
export const WINDOW_TYPES = {
  ...
  BG_DIFFUSION:'background-diffusion'
};
...
export const USER_MENU_ITEMS = (common) => [
  {
    title: 'Dashboard',
    icon: dashboardIcon,
    url: `${projectUrl(common)}/dashboard`,
    tooltip: 'Click to access your dashboard.',
    isTooltip: true,
    isFeatureDependence: true,
  },
  {
    title: 'Smart AI Mentors',
    icon: smartaimentorsIcon,
    url: `smartaimentors.videoremix.io/`,
    tooltip: 'Click to access your Smart AI Mentors.',
    isTooltip: false,
    isFeatureDependence: true,
  },
  {
  ...
  },
  {
    title: 'Zapier',
    icon: zapierIcon,
    url: 'zapier.com/apps/videoremix/integrations',
  },

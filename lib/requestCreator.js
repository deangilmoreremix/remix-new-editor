...
export const loadImage = async src => new Promise((resolve, reject) => {
  // TODO: To fix the CORS issue we need:
  //  1. Configure Amazon - dev-cdn.vidcloud.io domain should expose CORS headers
  //  2. Remove two lines below
  let url = src.replace(/^https:\/\//i, 'http://');
  url = url.replace('dev-cdn.vidcloud.io', 'vremix-dev.s3.amazonaws.com');

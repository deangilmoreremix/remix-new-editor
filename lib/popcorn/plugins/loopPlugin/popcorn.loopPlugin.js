...
import { START, END, LOOP, POPCORN_ELEMENT_TYPES } from '../../../constants/popcorn';
  ...
  }),
  {
    ...
    options: {
      ...
      [LOOP]: {
        ...
        elem: 'input',
        type: SELECT,
        default: 1, // not a 0, to enable loop work from moment when it added

  ...
  Popcorn.plugin('googlemap', function (options) {
    ...
    return {
      _setup(options) {
        ...
        const containerWidth = options.fullscreen ? 100 : options.width;
        const containerHeight = options.fullscreen ? 100 : options.height;
        ...
        _container.style.width = `${containerWidth || options._natives.manifest.options.width.default}%`;
        _container.style.height = `${containerHeight || options._natives.manifest.options.height.default}%`;
        _container.style.left = `${containerLeft || options._natives.manifest.options.left.default}%`;
        _container.style.top = `${containerTop || options._natives.manifest.options.top.default}%`;

  ...
  Popcorn.plugin('json-animation', {
    ...
    async _setup(options) {
      ...
      const animation = lottie.loadAnimation({
        container,
        animationData: await fetchAnimation(options.url),
        loop: false,
        autoplay: true,
      });
      console.log('popcorn JSON _setup animation loaded', animation);
      console.log('popcorn JSON _setup finished', options);
    },

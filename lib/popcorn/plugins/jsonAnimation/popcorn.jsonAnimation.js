...
import { JSON_ANIMATION, COUNT_FRAMES_IN, COUNT_FRAMES_OUT } from '../../../constants/settings/json-animation';
...
((Popcorn, jQuery) => {
  ...
  function getDefaultOptionValue(key) {
    const { options } = Popcorn.manifest[JSON_ANIMATION];

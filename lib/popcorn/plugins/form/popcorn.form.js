      ...
      _update(trackEvent, options) {
        ...
        if (trackEvent._container) {
          ...
          if (options.hasOwnProperty('innerOpacity')) {
            ...
            if (trackEvent.innerColor) {
              inner.style.background = trackEvent.innerColor.includes('#')
                ? getRgba(trackEvent.innerColor, options.innerOpacity)
                : rgbFade(trackEvent.innerColor,  trackEvent.innerOpacity / 100.0);
            }
          }

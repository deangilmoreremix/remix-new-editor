...
const FIELD_FONT_DECORATIONS = 'fontDecorations';
const FIELD_TOP = 'top';
const FIELD_LINK_URL = 'linkUrl';
...
((Popcorn, jQuery) => {
  ...
  Popcorn.plugin(VRTEXT, {
    ...
    _setup(options) {
      ...
      options.fontDecorations = toFillOptions(FIELD_FONT_DECORATIONS)

      options.left = toFillOptions(FIELD_LEFT);
      options.height = toFillOptions(FIELD_HEIGHT);
      options.width = toFillOptions(FIELD_WIDTH);
      options.top = toFillOptions(FIELD_TOP);
      options.linkUrl = toFillOptions(FIELD_LINK_URL);

...
((Popcorn, jQuery) => {
  ...
  Popcorn.plugin('text', {
    ...
    _setup(options) {
      ...
      options.animation = options._natives.manifest.options.animation.default;
    ...
    start(event, options) {
      if (!isSafari()) {
        ...
        if (options.animation.in) {
          animationContainer.classList.add(options.animation.in.type);
          if (options.animation.idle) {
            animationContainer.addEventListener('animationend', () => {
              ...
              animationContainer.classList.add(options.animation.idle.type);
            });
          }
        }
        ...
        setTimeout(() => {
          ...
          if (options.animation.in) {
            animationContainer.classList.add(options.animation.in.type);
            if (options.animation.idle.type) {
              animationContainer.addEventListener('animationend', () => {
                animationContainer.classList.remove(options.animation.in.type);
                animationContainer.classList.add(options.animation.idle.type);
              });
    ...
    _update(trackEvent, options) {
      ...
      if (!isSafari()) {
        if (options._animationContainer) {
          if (options.animation.out) {
            const animationContainer = options._animationContainer;
            if (animationContainer.classList.contains(options.animation.in.type)) {
              animationContainer.classList.remove(options.animation.in.type);
            }
            if (animationContainer.classList.contains(options.animation.idle.type)) {
              animationContainer.classList.remove(options.animation.idle.type);
            }
            ...
            animationContainer.addEventListener('animationend', () => {
              ...
              options._animationContainer.classList.remove('on');
              options._animationContainer.classList.add('off');
            });
          } else {
            options._animationContainer.classList.remove('on');
        ...
        setTimeout(() => {
          if (options._animationContainer) {
            if (options.animation.out) {
              const animationContainer = options._animationContainer;
              if (animationContainer.classList.contains(options.animation.in)) {
                animationContainer.classList.remove(options.animation.in);
              }
              if (animationContainer.classList.contains(options.animation.idle.type)) {
                animationContainer.classList.remove(options.animation.idle.type);
              }

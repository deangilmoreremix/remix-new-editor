...
const selectFonts = [];
fonts.map(item => (selectFonts.push({ label: item.toString(), value: item })));
    ...
    manifest: {
      ...
      options: {
        ...
        linkTarget: {
          ...
          name: 'linkTarget',
          type: 'select',
          items: [{label: 'New Tab', value: '_blank'}, {label: 'Current tab', value: '_parent'}],
          default: '_blank',
        },
        position: {
          elem: 'radio',
        ...
        fontFamily: {
          ...
          googleFonts: true,
          group: 'advanced',
          default: {label: 'Anton', value: 'Anton'},
        },
        fontSize: {
          elem: 'input',
          name: 'fontSize',

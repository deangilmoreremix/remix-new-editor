...
((Popcorn) => {
  let PLACEHOLDER_URL = 'https://cdn.vidcloud.io/src/plugins/personalizedImage/personalizedImage-placeholder.svg';
  let PLACEHOLDER_URL_CIRCLE = 'https://cdn.vidcloud.io/src/plugins/personalizedImage/personalizedImage-circle.png'
    ...
    _update(trackEvent, options) {
      if(options.imageshape !== undefined) {
        ...
        if(options.imageshape == 'circle') {
              PLACEHOLDER_URL = 'https://cdn.vidcloud.io/src/plugins/personalizedImage/personalizedImage-circle.png'

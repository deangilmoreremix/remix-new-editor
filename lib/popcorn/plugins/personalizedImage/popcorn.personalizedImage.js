...
((Popcorn) => {
  ...
  Popcorn.plugin('personalizedImage', {
    ...
    _setup(options) {
      ...
      options.width = options._natives.manifest.options.width.default;
      options.height = options._natives.manifest.options.height.default;
      options.left = options._natives.manifest.options.left.default;
      options.top = options._natives.manifest.options.top.default;

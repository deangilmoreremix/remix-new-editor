...
.theme-${id} button .settings__edit-file,
.theme-${id} .multiple-select-container .multiple-select .multiple__menu .multiple__menu-list .multiple__option--is-focused,
...
.theme-${id} .library-cta-items::-webkit-scrollbar-thumb,
.theme-${id} .container-tokens-textarea .text-area::-webkit-scrollbar-thumb,
.theme-${id} .multiple__menu .multiple__menu-list::-webkit-scrollbar-thumb,
...
.theme-${id} .multiple-select-container .multiple-select .multiple__control .multiple__dropdown-indicator:hover,
.theme-${id} .gif-library__header {
  color: ${theme.primaryColor};
}

.theme-${id} .MuiCheckbox-colorSecondary.Mui-checked,
.theme-${id} .multiple__dropdown-indicator:hover,
.theme-${id} .multiple__clear-indicator:hover,
.theme-${id} .multiple__multi-value__remove:hover,
...
.theme-${id} .multiple-select-container .multiple-select .multiple__control:hover,
.theme-${id} .multiple-select-container .multiple-select .multiple__multi-value,
...
.theme-${id} .multiple__control--is-focused,

...
const styleSheet =  (id, brandLogo, theme) => `
...
.theme-${id} .user-panel__data-field-link {
...
.theme-${id} .stepper-container .MuiStep-completed span .MuiStepLabel-iconContainer.MuiStepLabel-alternativeLabel,
.theme-${id} .add-folder-modal__content-data__buttons-box button {
.theme-${id} .button.generator-use,
.theme-${id} .drop-area__icon svg,
.theme-${id} .user-panel__buttons-box-button,
.theme-${id} .avatar-dark-theme {
...
.theme-${id} .template-generator-header button.header-tabs__item--active,
.theme-${id} .generator-body .video-list .video__item:hover,
.theme-${id} .generator-body .video-list .video__item .buttons-container .video__item__button,
.theme-${id} .stepper-container .MuiStepIcon-active,
.theme-${id} .stepper-container .MuiStepIcon-completed,
.theme-${id} .stepper-container .MuiStepConnector-active span,
.theme-${id} .stepper-container .MuiStepConnector-completed span,
.theme-${id} .generator-body .niche-scripts-list .niche-script:hover,
.theme-${id} .generator-body .niche-scripts-list .niche-script:hover .niche-script__button,
.theme-${id} .generator-body .overlays .overlays__item:hover,
.theme-${id} .niche-scripts-preview-modal__button,
...
.theme-${id} .account-navigation-logo svg path {

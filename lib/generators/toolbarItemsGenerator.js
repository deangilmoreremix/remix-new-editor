...
import { TABS as JSON_ANIMATION_TABS } from '../constants/settings/json-animation';
import { TABS as VRTEXT_ELEMENT_TABS } from '../constants/settings/vrtext-element';
...
export const sharePanelItems = ({ actions }) => ([
  ...
  },
  {
    ...
    icon: svgRetarget,
    alwaysOnDisplay: !actions.modified && actions.optinCodeEnabled,
  },
  {
    action: () => actions.openModal(SOCIAL_CAMPAIGN_MODAL),
    label: 'List Builder',

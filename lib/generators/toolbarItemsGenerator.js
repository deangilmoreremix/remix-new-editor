...
import { EMAIL_CAMPAIGN_MODAL, SOCIAL_CAMPAIGN_MODAL } from '../../globals/stores/modal.store';
...
export const sharePanelItems = ({ actions }) => [
  {
    ...
    icon: svgVRText,
    // renderer: EmailCampaign,
  },
  {
    action: () => actions.openModal(SOCIAL_CAMPAIGN_MODAL),
    label: 'Social campaign',
    icon: svgTextMask,
    // renderer: SocialCampaign,
  },
];

export const produceItems = ({ actions }) => [
  {
    label: 'Settings',
    icon: svgVRText,

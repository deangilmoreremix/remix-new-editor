...
export const elementItems = ({
  ...
  // {
  //   action: () => actions.setSecondaryWindowType(WINDOW_TYPES.EVOLUTION_BLEND_MODE_LIBRARY),
  //   label: 'Blend Modes 2',
  //   icon: svgBlendModes,
  //   disabled: !evolutionBlendModeEnabled,
  //   uiSection: SECTIONS.basic,
  // },
  {
    action: () => {
  ...
  // {
  //   action: () => actions.setSecondaryWindowType(WINDOW_TYPES.CTA_EVOLUTION),
  //   label: 'CTA 2',
  //   icon: svgCTA,
  //   disabled: !evolutionCtaEnabled,
  //   uiSection: SECTIONS.basic,
  // },
  ...
  //   label: 'LT Presets 2',
  //   icon: svgPresets,
  //   disabled: !evolutionPresetEnabled,
  //   uiSection: SECTIONS.basic,
  // },

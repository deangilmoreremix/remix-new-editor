...
export const elementItems = ({
...
}) => [
  {
    action: () => {
      ...
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.TEXT]);
    },
    label: 'Smart Text',
    icon: svgVRText,
    disabled: false,
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.PERSONALIZED_IMAGE]);
    },
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.LEAD_GENERATOR]);
    },
  ...
  },
  {
    ...
    disabled: !(textToSpeechStandardEnabled || textToSpeechNeuralEnabled),
  },
  {
    action: () => {
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.BACKGROUND]);
    },
    label: 'Wrapper',
    icon: svgBackground,
  ...
  // },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.JSON_ANIMATION]);
    },
    label: 'JSON',
    icon: svgJson,
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.JSON_BUTTON]);
    },
    label: 'JSON Button',
    icon: svgJson,
    disabled: !isSuperAdmin,
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.JSON_TRANSITION]);
    },
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.SKIP]);
    },
    label: 'Skip',
    icon: svgSkip,
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.LOOP]);
    },
    label: 'Loop',
    icon: svgLoop,
    disabled: false,
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.PAUSE]);
    },
    label: 'Pause',
    icon: svgPause,
    disabled: false,
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.GOOGLE_MAP]);
    },
    label: 'Google Map',
    icon: svgMaps,
  ...
  },
  {
    action: () => {
      actions.toggleLeftBlock(false);
      actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.TEXT_MASK]);
    },
    label: 'Text Mask',
    icon: svgTextMask,

...
export const elementItems = ({
  ...
  },
  {
    action: () => {
      releaseElement();
      actions.setRecorder(WINDOW_TYPES.RECORDER);
    },
    label: 'ScreenRec',
    icon: svgScreenRec,
  ...
  {
    action: () => actions.openSecondaryModal(WINDOW_TYPES.TEXT_TO_SPEECH),
  ...
  {
    action: () => actions.addElement(DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.TEXT_MASK]),
    label: 'Text Mask',
    icon: svgTextMask,

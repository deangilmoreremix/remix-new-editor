...
import svgBgDiffusion from '../../public/static/images/toolbar/background_diffusion.svg';
import svgAiArtGenerator from '../../public/static/images/toolbar/ai_art_generator.svg'
...
export const elementItems = ({
  ...
  project: {
    ...
    {
      action: () => {
        actions.setAiGeneratorImage();
        actions.openAiArtGenerator(WINDOW_TYPES.AI_ART_GENERATOR);
      },
      label: 'AI Art Generator',
      icon: svgAiArtGenerator,
      disabled: !smartAiArtGeneratorEnabled,
      uiSection: SECTIONS.advanced,
    },
    {
      action: () => actions.openAiArtGenerator(WINDOW_TYPES.BG_DIFFUSION),
      label: 'BG Diffusion',
      icon: svgBgDiffusion,
      disabled: !smartBgDeffusionEnabled,
      uiSection: SECTIONS.advanced,
    },
    // {
    //   action: (newOptions) => {

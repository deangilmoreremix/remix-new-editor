...
import { PRODUCE_TABS, TOOLBARS, WINDOW_TYPES } from '../constants/ui';
import { FEATURES } from '../constants/features';

export const elementItems = ({
  actions,
  project: { isSuperAdmin, isfeatureEnabled, recorderEnabled, stickersEnabled, lowerThirdsEnabled },
}) => [
  {
  ...
  },
  {
    ...
    disabled: false,
    hidden: !isSuperAdmin
      && !isfeatureEnabled(FEATURES.LISTBUILDER),
  },
  {
  ...
  {
    action: () => actions.setLibraryType(WINDOW_TYPES.RECORDER),
    label: 'ScreenRec',
    icon: svgScreenRec,
...
export const sharePanelItems = ({
  ...
  actions, project: { allowedSocials: socials, modified, videoUrl },
}) => ([{
...
},
{
  ...
  errorMessage: 'Please allow Facebook or LinkedIn in our project to continue',
},
// ToDo remove "//"
// {

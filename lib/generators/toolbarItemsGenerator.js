...
export const elementItems = ({
...
}) => [
  {
    action: (position) => {
      ...
      actions.addElement({ ...DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.TEXT] }, position);
    },
    label: 'Smart Text',
    icon: svgVRText,
    disabled: false,
  ...
  },
  {
    action: (position) => {
      actions.toggleLeftBlock(false);
      actions.addElement({ ...DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.SOCIAL] }, position);
    },
    label: 'Social',
    icon: svgSocial,
  ...
  },
  {
    action: (position) => {
      actions.toggleLeftBlock(false);
      actions.addElement({ ...DEFAULT_SETTINGS[POPCORN_ELEMENT_TYPES.GOOGLE_MAP] }, position);
    },
    label: 'Google Map',
    icon: svgMaps,

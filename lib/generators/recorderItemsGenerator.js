...
export default ({ actions, useAudio, toggleAudio, volume }) => [
  {
    id: RECORDER_TYPES.AUDIO,
    label: 'Audio',
    icon: svgAudio,
    action: () => {
      actions.openModal(RECORDER_MODAL,
        { type: RECORDER_TYPES.AUDIO, useAudio, toggleAudio, volume });
    },
  },
  {
    ...
    action: () => {
      actions.openModal(RECORDER_MODAL,
        { type: RECORDER_TYPES.CAMERA, useAudio, toggleAudio, volume });
    },
  },
  {
    ...
    action: () => {
      actions.openModal(RECORDER_MODAL,
        { type: RECORDER_TYPES.SCREEN, useAudio, toggleAudio, volume });
    },
  },
];

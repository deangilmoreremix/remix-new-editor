...
module.exports = {
  init: (global) => {
    ...
    require('./popcorn/plugins/jsonTransition/popcorn.jsonTransition');
    require('./popcorn/plugins/lottie-json/popcorn.lottie-json');
    require('./popcorn/plugins/json-button/popcorn.json-button');
    ...
    require('./popcorn/plugins/background/popcorn.background');
  },

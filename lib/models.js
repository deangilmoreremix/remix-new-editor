...
export const MODELS = {
  ...
  // Voice Cloning and TTS Models (via Muapi)
  'elevenlabs-voice-clone': {
    name: 'ElevenLabs Voice Clone',
    provider: 'elevenlabs',
    type: 'voice-cloning',
    features: ['voice-cloning', 'high-quality', 'natural'],
  ...
  'coqui-voice-clone': {
    ...
    provider: 'coqui',
    type: 'voice-cloning',
    features: ['voice-cloning', 'open-source', 'customizable'],
  ...
  'elevenlabs-tts': {
    ...
    provider: 'elevenlabs',
    type: 'text-to-speech',
    features: ['high-quality', 'natural', 'multilingual'],
    languages: ['en', 'es', 'fr', 'de', 'it', 'pt', 'pl', 'tr', 'ru', 'nl', 'cs', 'ar', 'zh', 'ja', 'hu', 'ko', 'hi', 'sv', 'da', 'no', 'fi']
  },
  'openai-tts': {
    name: 'OpenAI TTS',
    provider: 'openai',
    type: 'text-to-speech',
    features: ['fast', 'multilingual', 'affordable'],

...
Any of OpenThorn's 12 supported providers works: OpenAI, Anthropic, Google Gemini, DeepSeek, Mistral AI, Groq, xAI, Perplexity, OpenRouter, Ollama, Cerebras, or NVIDIA NIM. If you are unsure, OpenAI or Anthropic are the easiest starting points. See our guide on [how to get an API key](/blog/how-to-get-an-ai-api-key) for exact steps.

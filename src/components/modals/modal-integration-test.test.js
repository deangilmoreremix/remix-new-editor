...
const MODAL_FILES = [
  ...
  { name: 'CreateProjectModal', path: './CreateProjectModal.js', exportName: 'default' },
  ...
  { name: 'ImageCropperModal', path: './ImageCropperModal.js', exportName: 'default' },
  { name: 'LeadGeneratorModal', path: './LeadGeneratorModal.jsx', exportName: 'LeadGeneratorModal' },
  { name: 'OpenAIImageEditorModal', path: './OpenAIImageEditorModal.jsx', exportName: 'default' },
  ...
  { name: 'SettingsModal (js)', path: './SettingsModal.js', exportName: 'default' },
  ...
  { name: 'SubtitleEditorModal', path: './SubtitleEditorModal.jsx', exportName: 'default' },
  { name: 'TemplateGeneratorModal', path: './TemplateGeneratorModal.jsx', exportName: 'TemplateGeneratorModal' },
  { name: 'TemplatePreviewModal (js)', path: './TemplatePreviewModal.js', exportName: 'default' },

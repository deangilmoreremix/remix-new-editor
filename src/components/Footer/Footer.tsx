      ...
      <div className={styles.inner}>
        ...
        <div className={styles.bottom}>
          <span className={styles.copyright}>
            &copy; {new Date().getFullYear()} SmartVideo. All rights reserved.
          </span>
          <div className={styles.socials}>
            <a href="https://github.com/BuildingTechAlternatives/SmartVideo" aria-label="GitHub" target="_blank" rel="noopener noreferrer">

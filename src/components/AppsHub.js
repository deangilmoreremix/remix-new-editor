...
const AI_APPS = [
  ...
  { id: 'lipsync', name: 'Lip Sync', description: 'Animate portraits or sync lips to audio with AI', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg>', badge: 'Lip Sync', color: 'bg-rose-500/10 text-rose-400 border-rose-500/20' },
  { id: 'leadfinder', name: 'Smart Video Lead Finder', description: 'Discover local businesses, generate outreach, and build demo sites', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>', badge: 'Leads', color: 'bg-orange-500/10 text-orange-400 border-orange-500/20' },
  { id: 'render', name: 'Video Render', description: 'Render and export your video projects', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="5 3 19 12 5 21 5 3"/><line x1="19" y1="3" x2="19" y2="21"/></svg>', badge: 'Export', color: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' },
  { id: 'brightbean', name: 'Brightbean Studio', description: 'Social media scheduling, analytics, and AI caption generation', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2a10 10 0 100 20 10 10 0 000-20z"/><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="1"/></svg>', badge: 'Social', color: 'bg-purple-500/10 text-purple-400 border-purple-500/20' },
];

// SmartVideo Studio — embedded iframe wrapper for the SmartVideo AI Website Builder.
...
export function SmartVideoStudio() {
  ...
  // SmartVideo-style header with matching design tokens
  ...
  header.innerHTML = `
    <div style="display:flex;align-items:center;gap:10px;">
      ...
      <span style="color:var(--color-text);font-weight:600;font-size:14px;font-family:var(--font-body);">SmartVideo</span>
  ...
  iframe.setAttribute('title', 'SmartVideo Studio');

/**
 * MODEL FAMILIES
 * Builds model catalogs and picker entries from local model arrays.
 * Adapted from upstream Open-Generative-AI packages/studio/src/modelFamilies.js
 */

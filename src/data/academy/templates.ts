...
export interface AcademyTemplateMeta {
  ...
  description: string;
  lessonId: string;
  /** Linked recipe id used by the "Create With Smart Video" button. */
  recipeId: string;
  assetIds: string[];
  /** Primary action label — "Use Template" for fill-in docs, "Create With Smart Video" for generative ones. */
  ctaLabel: string;
}
...
export interface UGCScriptChecklistItem {
  id: string;
  label: string;
  checked: boolean;
}
export interface UGCScriptData {
  product: string;
  targetLength: string;
  hook: UGCScriptBeat;
  problemPitch: UGCScriptBeat;
  proofDemo: UGCScriptBeat;
  cta: UGCScriptBeat;
  checklist: UGCScriptChecklistItem[];
}
...
// ---------------------------------------------------------------------------
export interface CharacterCheckItem {
  id: string;
  label: string;
  note?: string;
}
export interface CharacterChecklistData {
  character: string;
  items: CharacterCheckItem[];
  shots: string[];
  /** example[shotLabel][itemId] = verdict text */
  example: Record<string, Record<string, string>>;
}
...
// ---------------------------------------------------------------------------
export interface BatchAdRow {
  id: string;
  hook: string;
  angle: string;
  notes: string;
}
export interface BatchMatrixData {
  product: string;
  constants: string;
  rows: BatchAdRow[];
}
...
// ---------------------------------------------------------------------------
export interface AcademyTemplateBundle {
  meta: AcademyTemplateMeta;
  blank: unknown;
  example: unknown;
}

export const ACADEMY_TEMPLATES: AcademyTemplateMeta[] = [
  {
    id: 'ugc-script',
    kind: 'ugc-script',

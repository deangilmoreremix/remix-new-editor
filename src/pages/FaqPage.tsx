...
const RICH_ANSWERS: Record<string, React.ReactNode> = {
  ...
  'Where do I get an API key?': (
    <>
      ...
      Smart Video&rsquo;s Providers page.
    </>
  ),
  'Which AI providers are supported?': (
    <>
      Smart Video supports 12 AI providers: OpenAI, Anthropic, Google Gemini, DeepSeek, Mistral AI,
  ...
  'How much does building a website cost?': (
    <>
      ...
      in provider API usage. Smart Video itself charges nothing — there is no subscription and no
...
export default function FaqPage() {
  usePageTitle('FAQ', {
    description: 'Answers to common questions about Smart Video — how bring-your-own-key works, supported AI providers, costs, and deploying your generated site.',
  })
      ...
      <div className={styles.container}>
        <header className={styles.hero}>
          ...
          <p className={styles.subtitle}>
            Everything you need to know about Smart Video. Can&rsquo;t find your answer?{' '}

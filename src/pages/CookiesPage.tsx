...
export default function CookiesPage() {
  usePageTitle('Cookie Policy', {
    description: 'How Smart Video uses cookies and local storage. We use only essential cookies for authentication — no tracking or advertising cookies.',
  })
  return (
    <LegalPage title="Cookie and Storage Policy" lastUpdated="June 10, 2026">
      ...
      <p>
        ...
        <strong>sessionStorage</strong>. This page explains what Smart Video stores in your
        browser and why.
      </p>

      <h2>2. Essential Authentication Storage</h2>
      <p>
        Smart Video uses Supabase Auth to keep you signed in and protect account-only pages.
      ...
      <p>
        Smart Video also uses localStorage for product features that need to survive page
      ...
      <p>
        Smart Video does not use analytics cookies, advertising cookies, retargeting
      ...
      <p>
        Smart Video's fonts are self-hosted and served from our own infrastructure — no
        ...
        Smart Video for advertising or behavioural tracking, but the third-party provider

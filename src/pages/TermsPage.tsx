...
export default function TermsPage() {
  usePageTitle('Terms of Service', {
    description: 'The terms governing your use of Smart Video, the free bring-your-own-key AI website builder.',
  })
  return (
    <LegalPage title="Terms of Service" lastUpdated="June 8, 2026">
      <h2>1. About Smart Video</h2>
      <p>
        Smart Video is a free AI web builder. You describe what you want; Smart Video generates
      ...
      <p>
        By creating an account or using the service, you agree to these Terms of Service.
         If you do not agree, do not use Smart Video.
      </p>
      ...
      <p>
        Smart Video does not provide AI model access. You connect your own API keys from
      ...
      <ul>
        <li>
          ...
          to the AI provider you select. Smart Video does not charge for your provider
        ...
        <li>
          To fulfil your request, Smart Video may send your API key or authorization
        ...
        <li>
          You are responsible for all costs incurred with your AI provider. Smart Video
          charges you nothing.
        </li>
        <li>
      ...
      <h2>5. Acceptable Use</h2>
        <p>You agree not to use Smart Video to:</p>
      <ul>
      ...
      <p>
        ...
        your prompts. By using the service, you grant Smart Video a limited, non-exclusive
      ...
      <p>
        The Smart Video name, logo, and interface design are our intellectual property.
        Nothing in these Terms transfers any ownership of Smart Video's brand or software to
      ...
      <p>
        Smart Video is an AI-powered service subject to Regulation (EU) 2024/1689 (the EU AI
      ...
      <ul>
        ...
        <li>
          <strong>Bring Your Own Keys.</strong> Smart Video does not operate AI models.
        ...
        <li>
          <strong>No prohibited practices.</strong> Smart Video does not use AI to
      ...
      <p>
        Smart Video may host public user content, including Community projects and related
      ...
      <p>
        To the maximum extent permitted by applicable law, Smart Video and its operators

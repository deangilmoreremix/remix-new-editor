          ...
          <DndProvider backend={HTML5Backend}>
            ...
            && this.stores.common.scriptStatistic && (
              ...
              />`,
                ...
                />
                {this.stores.common.facebookPixelId && (
                  <noscript dangerouslySetInnerHTML={{
                    __html: `<img
                    height="1"
                    width="1"
                    style="display:none"
                    src='https://www.facebook.com/tr?id=${this.stores.common.facebookPixelId}&ev=PageView&noscript=1'/>`,
                  }}
                  />
                )}
              </>
            ...
            <div className={`theme-${whiteLabelManager.key} ${layoutClassName} ${className}-baseheader`}>
              <Head>
                ...
                var f=d.getElementsByTagName(s)[0],
                  ...
                  fbq('init', ${this.stores.common.facebookPixelId});
                  fbq('track', 'PageView', {'current_user_id': '${this.currentUser.id}', current_user_email: '${this.currentUser.email}'});`,
                      }}
                      />
                    )}
                  </>

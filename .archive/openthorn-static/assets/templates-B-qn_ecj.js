const l=[e(),a(),t(),r(),o(),i(),s(),n(),c()];function e(){return{id:"creative-portfolio",name:"Creative Portfolio",description:"A dark, cinematic portfolio for designers and developers.",category:"Portfolio",accentColor:"#7c6af7",highlights:["Editorial hero with crisp service positioning","Filterable case-study grid with real project imagery","Skill groups with polished capability meters","Accessible contact form with proof points"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
...
@media(max-width:768px){.nav-links{display:none}.contact-grid{grid-template-columns:1fr;gap:2.5rem}.skills-grid{grid-template-columns:1fr}.projects-grid{grid-template-columns:1fr}}`},{path:"src/App.tsx",language:"tsx",code:`import Navbar from './components/Navbar'
...
}`},{path:"src/components/Navbar.tsx",language:"tsx",code:`import { useState, useEffect } from 'react'
...
}`},{path:"src/components/Hero.tsx",language:"tsx",code:`export default function Hero() {
  return (
...
}`},{path:"src/components/Projects.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/Skills.tsx",language:"tsx",code:`const GROUPS = [
...
}`},{path:"src/components/Contact.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`}]}}function a(){return{id:"saas-landing",name:"SaaS Landing Page",description:"A polished SaaS landing page with strong conversion sections and product storytelling.",category:"SaaS",accentColor:"#2563eb",highlights:["Clear hero, proof metrics, and animated dashboard mockup","Feature grid, testimonial cards, and pricing tiers","FAQ accordion with smooth expand/collapse behavior","Conversion-focused CTA section and footer"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:768px){.nav-links{display:none}.mockup-sidebar{display:none}}`},{path:"src/App.tsx",language:"tsx",code:`import Navbar from './components/Navbar'
import Hero from './components/Hero'
...
}`},{path:"src/components/Navbar.tsx",language:"tsx",code:`export default function Navbar() {
  return (
...
}`},{path:"src/components/Hero.tsx",language:"tsx",code:`const BAR_HEIGHTS = [40, 65, 50, 80, 60, 90, 70, 55, 75, 85, 45, 95]
...
}`},{path:"src/components/Features.tsx",language:"tsx",code:`const FEATURES = [
...
}`},{path:"src/components/Testimonials.tsx",language:"tsx",code:`const TESTIMONIALS = [
...
}`},{path:"src/components/Pricing.tsx",language:"tsx",code:`const PLANS = [
...
}`},{path:"src/components/FAQ.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`}]}}function t(){return{id:"ecommerce-storefront",name:"E-commerce Storefront",description:"A premium product storefront with cart drawer and editorial aesthetic.",category:"E-commerce",accentColor:"#1a5c3a",highlights:["Editorial commerce hero with real product photography","Responsive product grid with hover quick-add","Slide-in cart drawer with quantity controls","Refined category navigation and sticky header"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:768px){.nav-links{display:none}.products-grid{grid-template-columns:repeat(2,1fr)}.footer-inner{grid-template-columns:1fr}}`},{path:"src/App.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/Navbar.tsx",language:"tsx",code:`interface NavbarProps { cartCount: number; onCartOpen: () => void }
...
}`},{path:"src/components/Hero.tsx",language:"tsx",code:`import type { CartItem } from '../App'
...
}`},{path:"src/components/Categories.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/ProductGrid.tsx",language:"tsx",code:`import type { CartItem } from '../App'
...
}`},{path:"src/components/CartDrawer.tsx",language:"tsx",code:`import type { CartItem } from '../App'
...
}`}]}}function r(){return{id:"photography-studio",name:"Photography Studio",description:"An image-led portfolio for photographers with a refined editorial presentation.",category:"Portfolio",accentColor:"#111111",highlights:["Full-bleed hero with atmospheric cover photography","Masonry-style gallery with lightbox preview","Editorial about section with portrait and client stats","Elegant booking inquiry form"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:640px){.nav-links{display:none}.gallery-grid{columns:1}}`},{path:"src/App.tsx",language:"tsx",code:`import Navbar from './components/Navbar'
import Hero from './components/Hero'
...
}`},{path:"src/components/Gallery.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/About.tsx",language:"tsx",code:`export default function About() {
  return (
...
}`}]}}function o(){return{id:"restaurant-landing",name:"Restaurant Landing",description:"A refined restaurant website with cinematic imagery, menu browsing, and reservations.",category:"Restaurant",accentColor:"#c9883a",highlights:["Cinematic hero with real restaurant photography","Interactive menu with categories and dish photography","Reservation form with service time and party size","Chef story, press mentions, and luxury footer"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:640px){.nav-links{display:none}.hero-hours{gap:1.5rem;font-size:.6rem}}`},{path:"src/App.tsx",language:"tsx",code:`import Navbar from './components/Navbar'
import Hero from './components/Hero'
...
}`},{path:"src/components/Menu.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/Chef.tsx",language:"tsx",code:`export default function Chef() {
  return (
...
}`},{path:"src/components/Reservation.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`}]}}function i(){return{id:"tech-blog",name:"Tech Blog",description:"A clean editorial blog for technical teams, creators, and thought leaders.",category:"Blog",accentColor:"#e85d2f",highlights:["Featured hero article with strong cover photography","Article grid with authors, dates, and reading time","Tag filter bar for quick content discovery","Newsletter signup section with confirmation state"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:768px){.featured-article{grid-template-columns:1fr}.nav-search,.nav-links{display:none}.articles-grid{grid-template-columns:1fr}.newsletter-form{flex-direction:column}}`},{path:"src/App.tsx",language:"tsx",code:`import Navbar from './components/Navbar'
...
}`},{path:"src/components/FeaturedArticle.tsx",language:"tsx",code:`export default function FeaturedArticle() {
  return (
...
}`},{path:"src/components/ArticleGrid.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`},{path:"src/components/Newsletter.tsx",language:"tsx",code:`import { useState } from 'react'
...
}`}]}}function s(){return{id:"wellness-clinic",name:"Wellness Clinic",description:"A calm, trustworthy clinic website with services, practitioners, and appointment booking.",category:"SaaS",accentColor:"#0f766e",highlights:["Warm healthcare hero with real lifestyle imagery","Service cards, practitioner profiles, and clinic stats","Appointment request form with confirmation state","Trust-focused layout for modern wellness practices"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
...
@media(max-width:640px){.grid2,.proof{grid-template-columns:1fr}.hero{padding-top:2rem}.metric-card{position:static;margin-top:1rem}}`},{path:"src/App.tsx",language:"tsx",code:`import { useState } from 'react'
import './styles/theme.css'
...
}`}]}}function n(){return{id:"real-estate-agency",name:"Real Estate Agency",description:"A premium property website for boutique real estate teams and luxury listings.",category:"Portfolio",accentColor:"#b45309",highlights:["Luxury property hero with editorial layout","Featured listings with real home photography","Agent profile, market stats, and inquiry form","Responsive design for listing discovery"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
...
@media(max-width:640px){.head{display:block}.grid2{grid-template-columns:1fr}.stats{grid-template-columns:1fr}}`},{path:"src/App.tsx",language:"tsx",code:`import { useState } from 'react'
import './styles/theme.css'
...
}`}]}}function c(){return{id:"conference-event",name:"Conference Event",description:"A sharp event website for conferences, summits, and launch gatherings.",category:"Blog",accentColor:"#dc2626",highlights:["High-impact hero with real audience photography","Schedule tabs, speaker cards, and ticket tiers","Sponsor-ready layout with strong conversion CTA","Responsive event landing page structure"],files:[{path:"src/styles/theme.css",language:"css",code:`*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
...
@media(max-width:640px){.speakers,.tickets{grid-template-columns:1fr}.hero{min-height:760px}.event-card{width:100%}}`},{path:"src/App.tsx",language:"tsx",code:`import { useState } from 'react'
import './styles/theme.css'

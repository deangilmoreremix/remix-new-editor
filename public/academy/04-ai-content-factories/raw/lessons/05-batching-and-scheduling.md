...
<p align="center">
<img src="../images/batch-production-suite.jpg" alt="Batch Suite" width="280">
<img src="../gifs/batch-suite-clip.gif" alt="Calendar Video Motion (I2V)" width="280">
</p>
<p align="center"><sub>Batch Schedule Image (Left) ──► Image-to-Video Motion (Right) · Video File: <a href="../videos/batch-suite-clip.mp4">../videos/batch-suite-clip.mp4</a></sub></p>
